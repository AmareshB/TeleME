...
public class PendingIntentsDataSource {
	...
	// Database fields
	  ...
	  public boolean deletePendingIntentName(String name) 
		{
		 // System.out.println("aa"+name);
		 
		      return database.delete(PendingIntentSQLiteHelper.TABLE_PENDINGINTENT, PendingIntentSQLiteHelper.COLUMN_RECEIVERNAME + "=" + name, null) > 0;
